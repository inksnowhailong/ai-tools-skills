---
name: tvs-pullread
description: 当用户说"看看远程改了什么、拉之前帮我看看、别人提交了啥、分析下这个 PR、远程有什么更新、这次合并安不安全"等远程变更解读类诉求时使用。作用：在业务/功能层面提炼远程 diff（不逐文件罗列改动），标注每个变更的意图与风险，提示潜在合并冲突；分析后询问是否合并、是否需要协助处理冲突。
---
