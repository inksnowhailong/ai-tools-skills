---
name: tvs-clean-code
description: 【已废弃】代码清洁 —— 当用户说"清理/整理这段代码、加点注释、可读性太差、看不懂这段、把代码弄干净"等代码整洁类诉求时使用。作用：代码清洁与注释增强，让意图清晰、自解释，降低阅读与维护的认知成本。
disable-model-invocation: true
---

> **⚠ 本 skill 已废弃**（2026-09-21）。
> 改用内置 `/simplify`（只做质量清理，不找 bug）。
> 文件保留仅供查阅与回滚，不再维护；已关闭模型自动调用，仍可用 `/tvs-clean-code` 手动唤起。
